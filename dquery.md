...
*It is highly recommended that you are familiar with the IATI Standard elements and have a basic understanding of querying in SQL using JSONB data types in PostgreSQL.*
